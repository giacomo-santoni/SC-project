...
> N.B. Before running https://./cnn_model.ipynb, consult the _Dataset_ section for the instructions to download data and the _Code execution_ section for the libraries needed. 
